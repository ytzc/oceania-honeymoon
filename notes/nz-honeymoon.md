...
| **NZ D9** | **5/12 週二** | **但尼丁** | 奧馬魯 → 但尼丁（約 120km）；奧塔哥半島・鐵路車站 |
| **NZ D10** | **5/13 週三** | **米佛峽灣 → 皇后鎮** | Milford Sound 一日遊（需提前預訂）→ 皇后鎮入住 |
...
**景點：**
- 🦭 奧塔哥半島（Otago Peninsula）— 信天翁・企鵝觀察
- 🚉 Dunedin Railway Station（歷史火車站，建議外觀拍照）
...
- 路線：Dunedin → Te Anau → Milford Sound → Queenstown
- ⚠️ 全天行程，車程長約 5–6 小時，需提前預訂遊船
...
| 付款 | Hostelworld 手續費 **€10.30**（已付）+ 到店付 **NZD 110.50** |
| 免費取消截止 | **5/06** |
...
| 類別 | 備註 |
|------|------|
| 住宿（16 晚）| SIN 2 + MEL 2 + CHC 3 + GRM 1 + FRJ 1 + WAN 1 + TKP 1 + OAM 1 + DUN 1 + ZQN 3 |
| 餐飲 | |
...
- [ ] ⭐⭐ 蒂卡波 2 晚（5/10–5/11）— 湖景 + 星空房
- [ ] 基督城 3 晚（5/04–5/06）— 第一晚靠近機場
- [ ] 葛雷茅斯 1 晚（5/07）
- [ ] 約瑟夫冰河 1 晚（5/08）
- [ ] 瓦納卡 1 晚（5/09）
- [ ] 但尼丁 1 晚（5/12）
...
- [ ] 🧊 Tasman Glacier 冰河船，NZD 209（NZ D8）
